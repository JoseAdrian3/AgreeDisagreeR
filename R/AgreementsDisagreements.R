...
#'
#' Function to generate the agreement and disagreement matrices from the metrics of three different algorithms.
#'
#' For the explanation of each type of matrix go to the documentation of the functions "agreements" and "disagreements".
#'
...
#' AgreeDisagreeR::agree_disagree("IPIP_unbalancing_complete.rds", "SMOTE_unbalancing_complete.rds", "ROSE_unbalancing_complete.rds", "IPIP", "SMOTE", "ROSE")
agree_disagree <- function(df1, df2, df3, name1, name2, name3){
  ...
  par(mfrow=c(2,2), mar=c(0,0,1,1), oma=c(0,0,1,0))
  ...
  mtext("Disagreement matrix", side=3, line=0, cex=0.9)
  ...
  mtext(paste0(name1, " agreement matrix"), side=3, line=0, cex=0.9)
  ...
  corrplot(agreementsA2, method = "circle", tl.srt = 45, type = "upper", col.lim = c(0,1), tl.cex = 0.7, mar = c(0,0,1,0))
  mtext(paste0(name2, " agreement matrix"), side=3, line=0, cex=0.9)
  ...
  corrplot(agreementsA3, method = "circle", tl.srt = 45, type = "upper", col.lim = c(0,1), tl.cex = 0.7, mar = c(0,0,1,0))
  mtext(paste0(name3, " agreement matrix"), side=3, line=0, cex=0.9)
}
